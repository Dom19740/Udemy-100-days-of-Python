...
food = Food()
scoreboard1 = Scoreboard((0, 275))
scoreboard2 = Scoreboard((0, -275))

screen.textinput("Use arrow keys", "Hit any key to start").lower()
...
def start_game():
    ...
    if restart == "y":
        ...
        scoreboard1.reset((0, 275))
        scoreboard2.reset((0, -275))
        start_game()
